...
const LatestWorks = () => {
  return (
 <section id="latest-works-section" className="max-w-screen-xl mx-auto px-4 relative pb-8 sm:pb-16">
        <h2
        ...
        >
          ...
          ></div>
          <div
            className="w-4 h-4 rounded-full border-[3px] border-[#459bd5] absolute left-[calc(50%+7px)] -translate-x-1/2 bg-[#111] z-10 hover:scale-110 ease-in-out duration-300 hidden sm:block"
          ></div>
          <a
        ...
        >
          ...
          ></div>
          <div
            className="w-4 h-4 rounded-full border-[3px] border-[#ffe578] absolute left-[calc(50%+7px)] -translate-x-1/2 bg-[#111] z-10 hover:scale-110 ease-in-out duration-300 hidden sm:block"
          ></div>
          <a
            href="#"
        ...
        >
          ...
          ></div>
          <div
            className="w-4 h-4 rounded-full border-[3px] border-[#fc815c] absolute left-[calc(50%+7px)] -translate-x-1/2 bg-[#111] z-10 hover:scale-110 ease-in-out duration-300 hidden sm:block"
          ></div>
          <a
            href="#"
            className="flex w-full relative justify-center sm:justify-start"
        ...
        >
          ...
          ></div>
          <div
            className="w-4 h-4 rounded-full border-[3px] border-[#47afa1] absolute left-[calc(50%+7px)] -translate-x-1/2 bg-[#111] z-10 hover:scale-110 ease-in-out duration-300 hidden sm:block"
          ></div>
          <a
            href="#"
            className="order-1 sm:order-2 flex w-full relative justify-center sm:justify-start"
